...
const ZoomStyleChat: React.FC<ZoomStyleChatProps> = ({ initialOpen = false, defaultLanguage = 'en' }) => {
              ...
              <Tabs value={multimodalTab} onValueChange={setMultimodalTab} className="w-full">
                ...
                <TabsContent value="qr">
                  <div className="text-center p-4 border rounded-md">
                    ...
                    >
                      <TranslatableText text="Upload Image" spanish="Cargar imagen" language={language} />
                    </Button>
                  </div>
                </TabsContent>
          ...
          <div className="p-4 border-t">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button 
                      ...
                      className={isMicActive ? "bg-red-500 hover:bg-red-600" : ""}
                    >
                      <Icons.mic className="h-4 w-4" />
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent>
                    <p>
                      <TranslatableText 
                        text={isMicActive ? 'Stop Voice Input' : 'Start Voice Input'} 
                        spanish={isMicActive ? 'Detener entrada de voz' : 'Iniciar entrada de voz'}
                        language={language}
                      />
                    </p>
                  </TooltipContent>
            ...
            <div className="mt-2 text-xs text-muted-foreground">
              <TranslatableText 
                ...
                spanish="Presiona Enter para enviar, Shift+Enter para una nueva línea"
                language={language}
              />
            </div>
          </div>
